<html><head><script>
    ...
    <script language="javascript" src="assets/scripts/valida_cpf.js"></script>
    ...
    <table width="80%" class="center pt100">
      <tbody>
        ...
        <tr>
          <td><input class="cpf" type="tel" id="cpf" name="cpf" onkeypress="return number(event)" maxlength="14"></td>
        </tr>    
      </tbody>
    </table>
    <div class="pt30">
        <input type="submit" id="btn-entrar" value="ENTRAR" onclick="return ValidaLogin()">
    </div>
    </form>
